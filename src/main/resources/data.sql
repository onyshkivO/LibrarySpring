...
VALUES ('admin', '123@gmail.com', '$2a$12$bqjD7W/Ez8sPcRVJtUMlgOErxUDHYBO/ztj5RLJ7cvFPesTNfZwq2', 'ROLE_ADMINISTRATOR', 'ACTIVE', 'Admin',
        'Admin', '0988255564'),
       ('user1', 'user1@gmail.com', '$2a$12$bqjD7W/Ez8sPcRVJtUMlgOErxUDHYBO/ztj5RLJ7cvFPesTNfZwq2', 'ROLE_READER', 'ACTIVE', 'Tom', 'Krit',
        null),
       ('blockedUser', 'blockedUser@gmail.com', '$2a$12$bqjD7W/Ez8sPcRVJtUMlgOErxUDHYBO/ztj5RLJ7cvFPesTNfZwq2', 'ROLE_READER', 1,
        'John', 'Tork', '0674521156'),
       ('user2', 'user2@gmail.com', '$2a$12$bqjD7W/Ez8sPcRVJtUMlgOErxUDHYBO/ztj5RLJ7cvFPesTNfZwq2', 'ROLE_READER', 'ACTIVE', 'Jean',
        'Boros', '0985644475'),
       ('librarian1', 'librarian1@gmail.com', '$2a$12$bqjD7W/Ez8sPcRVJtUMlgOErxUDHYBO/ztj5RLJ7cvFPesTNfZwq2', 'ROLE_LIBRARIAN', 'ACTIVE',
        'Vitalii', 'Tort', '0985625675'),
       ('librarian2', 'librarian2@gmail.com', '$2a$12$bqjD7W/Ez8sPcRVJtUMlgOErxUDHYBO/ztj5RLJ7cvFPesTNfZwq2', 'ROLE_LIBRARIAN', 'ACTIVE',
        'Max', 'Verst', '0985644145'),
       ('librarian3', 'librarian3@gmail.com', '$2a$12$bqjD7W/Ez8sPcRVJtUMlgOErxUDHYBO/ztj5RLJ7cvFPesTNfZwq2', 'ROLE_LIBRARIAN', 'ACTIVE',
